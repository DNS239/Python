...
def prever_afinidade_elemental(intensidade, componente_raro, fase_lunar, idade_feiticeiro, afinidade_animais):
    ...
    elif intensidade >= 9 and componente_raro and fase_lunar == "cheia" and idade_feiticeiro >= 80 and afinidade_animais:
        return "A afinidade elemental do feiticeiro é com o elemento Terra!"

        
    elif intensidade >= 8 and componente_raro and fase_lunar == "cheia" and idade_feiticeiro >= 80:
